...
class ANFIS:
    ...
    def trainHybridJangOffLine(self, epochs=30, tolerance=1e-5, initialGamma=0.999, k=0.01):
...
def load_abalone(file_name='C:/Users/Yashad/Desktop/Books/machine learning/abalone.txt'):
    abalone_convert = lambda x: 0 if b'M' in x else 1 if b'F' in x else 2
    data = np.loadtxt(file_name, delimiter=',', converters={0: abalone_convert})
